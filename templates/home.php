...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-2xl font-semibold mb-4 text-green-600">Étudiants</h2>
            <p class="mb-4 text-gray-700">Consultez la liste des étudiants par promotion.</p>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-2xl font-semibold mb-4 text-purple-600">Promotions</h2>
            <p class="mb-4 text-gray-700">Gérez les promotions de BTS SIO.</p>
